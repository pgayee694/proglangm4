...
{fin = [], trans = 1},
{fin = [(N 129)], trans = 0},
{fin = [(N 47),(N 129)], trans = 0},
{fin = [(N 97),(N 129)], trans = 5},
{fin = [(N 89)], trans = 0},
{fin = [(N 49),(N 129)], trans = 0},
{fin = [(N 116),(N 129)], trans = 8},
{fin = [(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 10},
{fin = [(N 116)], trans = 11},
{fin = [(N 116)], trans = 12},
{fin = [(N 116)], trans = 13},
{fin = [(N 14),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 15},
{fin = [(N 116)], trans = 16},
{fin = [(N 116)], trans = 17},
{fin = [(N 45),(N 113),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 19},
{fin = [(N 116)], trans = 20},
{fin = [(N 116)], trans = 21},
{fin = [(N 116)], trans = 22},
{fin = [(N 34),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 24},
{fin = [(N 116)], trans = 25},
{fin = [(N 3),(N 116)], trans = 8},
{fin = [(N 23),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 28},
{fin = [(N 116)], trans = 29},
{fin = [(N 18),(N 116)], trans = 8},
{fin = [(N 116)], trans = 31},
{fin = [(N 116)], trans = 32},
{fin = [(N 116)], trans = 33},
{fin = [(N 40),(N 113),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 35},
{fin = [(N 116)], trans = 36},
{fin = [(N 116)], trans = 37},
{fin = [(N 28),(N 116)], trans = 8},
{fin = [(N 116),(N 129)], trans = 39},
{fin = [(N 116)], trans = 40},
{fin = [(N 116)], trans = 41},
{fin = [(N 8),(N 116)], trans = 8},
{fin = [(N 67),(N 129)], trans = 0},
{fin = [(N 74),(N 129)], trans = 44},
{fin = [(N 77)], trans = 0},
{fin = [(N 91),(N 129)], trans = 46},
{fin = [(N 80)], trans = 0},
{fin = [(N 69),(N 129)], trans = 48},
{fin = [], trans = 49},
{fin = [], trans = 50},
{fin = [], trans = 51},
{fin = [(N 127)], trans = 51},
{fin = [(N 72)], trans = 0},
{fin = [(N 20),(N 129)], trans = 0},
{fin = [(N 103),(N 129)], trans = 55},
{fin = [(N 103)], trans = 55},
{fin = [(N 103),(N 129)], trans = 0},
{fin = [(N 63),(N 129)], trans = 0},
{fin = [(N 59),(N 129)], trans = 59},
{fin = [(N 55)], trans = 0},
{fin = [(N 57),(N 129)], trans = 61},
{fin = [(N 52)], trans = 0},
{fin = [(N 61),(N 129)], trans = 0},
{fin = [(N 95),(N 129)], trans = 0},
{fin = [(N 93),(N 129)], trans = 0},
{fin = [(N 129)], trans = 66},
{fin = [(N 86)], trans = 0},
{fin = [(N 65),(N 129)], trans = 0},
{fin = [(N 99),(N 129)], trans = 69},
{fin = [(N 83)], trans = 0},
{fin = [(N 119),(N 129)], trans = 71},
{fin = [(N 119)], trans = 71}])
end
