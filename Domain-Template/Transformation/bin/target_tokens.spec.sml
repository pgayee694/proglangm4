...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  101 => let val yytext=yymktext() in (*#line 78.45 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) SHELL("integer"   , yytext,     getNextTokenPos(yytext))    (*#line 609.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
| 111 => let val yytext=yymktext() in (*#line 79.45 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) SHELL("boolean"        , yytext,     getNextTokenPos(yytext))    (*#line 611.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
| 114 => let val yytext=yymktext() in (*#line 80.45 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) SHELL("id"        , yytext,     getNextTokenPos(yytext))    (*#line 613.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
| 117 => let val yytext=yymktext() in (*#line 82.28 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) getNextTokenPos(yytext); lex()  (*#line 615.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
| 125 => let val yytext=yymktext() in (*#line 83.41 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) SHELL(generateSchemaTokenName(yytext), yytext, getNextTokenPos(yytext))    (*#line 617.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
| 127 => let val yytext=yymktext() in (*#line 85.45 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec"*) error("ignored an unprintable character: " ^ yytext); getNextTokenPos(yytext); lex()  (*#line 619.1 "C:\Users\tkori\proglangm4\Domain-Template\Transformation\bin\target_tokens.spec.sml"*)
 end
